...
- Nom du fichier : Jukeboxx_Stock_YYYY-MM-DD_HH-MM-SS.xlsx

Important Streamlit Cloud :
La base stock.db locale n'est pas un stockage permanent garanti. Pense a telecharger les rapports Excel regulierement.
